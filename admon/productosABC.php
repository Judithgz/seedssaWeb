			...
			<div class="well" id="contenedor">
				...
				<form action="productosABC.php" method="post" enctype="multipart/form-data">
					...
					<div class="form-group text-left">
						...
						<textarea class="form-control" name="publico" id="publico"><?php print isset($id) ? $publico : ''; ?></textarea>
					</div>

					<div class="form-group text-left">
						<label for="objetivo">* Objetivos:</label>
						<textarea class="form-control" name="objetivo" id="objetivo"><?php print isset($id) ? $objetivo : ''; ?></textarea>
					</div>

					<div class="form-group text-left">
						<label for="necesario">* Necesario:</label>
						<textarea class="form-control" name="necesario" id="necesario"><?php print isset($id) ? $necesario : ''; ?></textarea>
					</div>
